...
public class CodeHierarchyHelper {
	...
	public static String getFormText(IDotNetElement element) {
		IDocumentation documentation = element.getDocumentation();
		return documentation == null ? null : getFormText(documentation);
	}
