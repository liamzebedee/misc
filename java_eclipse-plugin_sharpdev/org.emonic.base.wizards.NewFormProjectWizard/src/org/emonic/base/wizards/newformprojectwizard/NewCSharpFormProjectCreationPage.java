...
public class NewCSharpFormProjectCreationPage extends WizardNewProjectCreationPage {
	...
	public NewCSharpFormProjectCreationPage() {
		super(NewCSharpFormProjectCreationPage.class.getName());
