...
public class NewDotNetProjectCreationPage extends WizardNewProjectCreationPage {
	...
	public NewDotNetProjectCreationPage() {
		super(NewDotNetProjectCreationPage.class.getName());
