...
public class NewCSharpConsoleProjectCreationPage extends WizardNewProjectCreationPage {
	...
	public NewCSharpConsoleProjectCreationPage() {
		super(NewCSharpConsoleProjectCreationPage.class.getName());
