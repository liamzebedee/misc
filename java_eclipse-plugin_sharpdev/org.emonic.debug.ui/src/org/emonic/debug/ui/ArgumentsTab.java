...
public class ArgumentsTab extends AbstractLaunchConfigurationTab {
	...
	private void createProgramArgsGroup(Composite composite) {
		Group group = new Group(composite, SWT.NONE);
		group.setText(Messages.ArgumentsTab_ProgramArgumentsGroupLabel);
		group.setLayoutData(new GridData(SWT.FILL, SWT.BEGINNING, true, false));
		group.setLayout(new GridLayout(1, true));

		programArgsText = new Text(group, SWT.MULTI | SWT.BORDER | SWT.WRAP
				| SWT.V_SCROLL);
		GridData data = new GridData(SWT.FILL, SWT.BEGINNING, true, false);
		data.heightHint = 100;
		programArgsText.setLayoutData(data);
	}
	...
	public void createControl(Composite parent) {
		...
		createProgramArgsGroup(composite);
	...
	public void initializeFrom(ILaunchConfiguration configuration) {
		try {
			String programArgs = configuration.getAttribute(
