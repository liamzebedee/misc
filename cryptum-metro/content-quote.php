...
<a id="post-<?php the_ID(); ?>" <?php post_class( cryptum_metro_tile_class( cryptum_metro_get_color() ) ); ?> href="<?php the_permalink(); ?>">
	<div class="entry-content">
		<?php the_content(); ?>
	</div><!-- .entry-content -->
	
	<header class="entry-header">
		<h1 class="entry-title"><?php cryptum_seperator_html(); the_title(); ?></h1>
	</header><!-- .entry-header -->
</a><!-- #post-<?php the_ID(); ?> -->

<?php else : ?>
<article id="post-<?php the_ID(); ?>" <?php post_class( ); ?>">
	<div class="entry-content <?php cryptum_metro_tile_class( cryptum_metro_get_color(), true ) ?>">
		<?php the_content(); ?>
		<h1 class="entry-title"><?php cryptum_seperator_html(); the_title(); ?></h1>
	</div><!-- .entry-content -->
	...
	<footer class="entry-meta <?php cryptum_metro_tile_class( cryptum_metro_get_color(), true ) ?>">
		...
		<?php cryptum_seperator_html(); ?><a href="<?php echo get_post_format_link( 'quote' ) ?>"><?php _e('See all quotes', 'cryptum' ) ?></a>
	</footer><!-- .entry-meta -->
